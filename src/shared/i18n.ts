...
function resolveLocaleTag(locale: string): SupportedLocale | null {
  ...
  if (lowerLocale.startsWith("zh-hant") || lowerLocale === "zh-hk" || lowerLocale === "zh-mo") {
    return "zh-TW";
  }
  ...
  return SUPPORTED_LOCALES.find((supportedLocale) => lowerLocale.split("-")[0] === supportedLocale) ?? null;
}
